...
#include "TrafficLight.h" //added
// forward declarations to avoid include cycle
class Street;
class Vehicle;

//class TrafficLight; //added
//forward declaration does't work to add private member "TrafficLight Intersection::_trafficLight"
...
private:
    ...
    TrafficLight _trafficLight; //added
};
